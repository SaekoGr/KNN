...
class IOGnet(nn.Module):
    def __init__(self):
        ...
        self.conv1_enc = nn.Conv2d(64, 128, 3, padding=2, dilation=2)
        self.conv2_enc = nn.Conv2d(128, 256, 3, padding=2, dilation=2)
        self.conv3_enc = nn.Conv2d(256, 516, 3, padding=2, dilation=2)
